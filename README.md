...
1. **Data Ingestion:** Imported datasets into Databricks workspace and Spark environment.  
2. **Data Cleaning:** Used PySpark transformations to handle nulls, fix data types, and standardize schemas.  
3. **Exploratory Data Analysis (EDA):** Conducted SQL and visual analysis within Databricks to uncover trends.  
4. **Feature Engineering:** Encoded categorical features, created numeric features, and scaled data for ML pipelines.  
5. **Model Building:** Developed Logistic Regression, Linear Regression, and K-Means clustering models using Spark MLlib.  
6. **Evaluation:** Measured ROC-AUC, Accuracy, RMSE, and R² for model performance.  
7. **Visualization & Reporting:** Combined all results into an interactive Plotly Dash dashboard for unified insights.  
...
✨ *Prepared as part of the GE372 Big Data Analytics Course (MBA(General))*  
